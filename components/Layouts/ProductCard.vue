<template>
    <div
      class=" flex flex-col hover:scale-120 card bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
      v-for="item in productList">
      <a href="#">
        <img class="rounded-t-lg img flex justify-center w-full mb-1 lg:mb-5" :src=item.thumbnail alt="product image" />
      </a>
      <div class="px-5 pb-5">
        <a href="#">
